  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link js-scroll active" href="profile.php" style="color: blue;">Home</a>
          </li>
        ...
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              ...
              <div class="content-test">
                <p class="description lead">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum dolore praesentium facilis accusantium molestiae exercitationem ipsum recusandae sint ullam. Delectus dignissimos saepe mollitia doloribus error autem repellendus omnis nostrum quas.
                </p>
            ...
            <div class="testimonial-box">
              ...
              <div class="content-test">
                <p class="description lead">
                  Lorem ipsum dolor sit amet consectetur, adipisicing elit. A nostrum quae, iure aut facere sit incidunt tempora eligendi laboriosam adipisci recusandae vel sint sequi error doloribus, reiciendis omnis. Harum, exercitationem?
                </p>
                <span class="comit"><i class="fa fa-quote-right"></i></span>
              </div>
            </div>
