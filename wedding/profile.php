...
<body id="page-top">
            ...
            if (mysqli_num_rows($run) == 0) {
              ...
              echo " <div class='row'>
                        ...
                        <div class='col-md-2'><h5>$sum</h5></div>
                         ...
                         <div class='payment' href='payment.php'><div class='btn btn-outline-success'>Make Payment</div></div>
                       </div><br>";
            }
          }
          ?>
  ...
  <div class="container">
    ...
    <div class='payment'>
      <div class='btn btn-outline-success'><a href="payment.php">Make Payment</a></div>
    </div>
  </div>
        ...
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              ...
              <div class="content-test">
                <p class="description lead">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam rem hic sit accusamus, aliquid iure consequuntur officia? Quam praesentium omnis rerum necessitatibus expedita, unde, maiores voluptatibus eum commodi, esse vitae?
                </p>
            ...
            <div class="testimonial-box">
              ...
              <div class="content-test">
                <p class="description lead">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati necessitatibus assumenda minus repudiandae? Asperiores dicta, distinctio neque eveniet, aliquid delectus nobis adipisci perspiciatis modi voluptatum exercitationem veniam aliquam itaque cum.
                </p>
                <span class="comit"><i class="fa fa-quote-right"></i></span>
              </div>
            </div>
