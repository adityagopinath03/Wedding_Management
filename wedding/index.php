...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">A & A Wedding Planner</a>
  ...
  <div id="home" class="intro route bg-image" style="background-image: url(img/wed3.jpg)">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          <h1 class="intro-title mb-4">A & A Wedding Planner</h1>
          <p class="intro-subtitle"><span class="text-slider-items">Make Your Wedding Memorable,Hire Us. Rest on Us</span><strong class="text-slider"></strong></p>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    Welcome to A & A Wedding Planner, your dedicated partner in creating unforgettable wedding experiences. At A & A Wedding Planner, we understand that your wedding day is one of the most important moments of your life. Our mission is to bring your dream wedding to life with seamless planning, exceptional service, and meticulous attention.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              ...
              <div class="content-test">
                <p class="description lead">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Eveniet debitis quia quos reiciendis laboriosam alias quasi natus. Aspernatur, dolore deleniti.
                </p>
            ...
            <div class="testimonial-box">
              <div class="author-test">
                <img src="img/akshay.png" alt="" class="rounded-circle b-shadow-a" style="height: 250px; width: 250px;">
                <span class="author">Akshay Deo</span>
              </div>
              <div class="content-test">
                <p class="description lead">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci quisquam iste quam cumque nisi cupiditate perferendis porro aut, accusamus cum.
                </p>
                <span class="comit"><i class="fa fa-quote-right"></i></span>
              </div>
            </div>
